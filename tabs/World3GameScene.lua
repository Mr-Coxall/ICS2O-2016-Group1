...
World3GameScene = class()

function World3GameScene:init()
...
function World3GameScene:draw()
    ...
    sprite("Dropbox:Background3", WIDTH/2, HEIGHT/2, WIDTH)
    ...
    text("World: 3", WIDTH/1.14, HEIGHT/1.04)
